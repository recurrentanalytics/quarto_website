...
::: {.series-nav-links}
::: {.series-nav-prev}
[← Previous: Data](risk-series-2.html)
:::
::: {.series-nav-next}
:::
:::
...
Armed with the [theoretical foundations](risk-series-1.html) and [data sources](risk-series-2.html), we can now implement a basic risk model.
...
::: {.backlinks}
#### Linked from
- [Risk Modelling Part 2: Data](risk-series-2.html)
:::
