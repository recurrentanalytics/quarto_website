...
::: {.series-nav-links}
::: {.series-nav-prev}
[← Previous: Foundations](risk-series-1.html)
:::
::: {.series-nav-next}
[Next: Implementation →](risk-series-3.html)
:::
:::
:::
...
Building on the [foundations from Part 1](risk-series-1.html), this note covers the data landscape for climate risk modelling.
...
With data in hand, we move to [Part 3: Implementation](risk-series-3.html) where we build actual models.

::: {.backlinks}
#### Linked from
- [Risk Modelling Part 1: Foundations](risk-series-1.html)
- [Risk Modelling Part 3: Implementation](risk-series-3.html)
:::
